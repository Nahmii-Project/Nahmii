...
const Home = () => {
     return (
      <main>
        <Navbar/>
        <div className='border border-[#902784] rounded-3xl border-solid w-[90%] mt-4 lg:w-[60%] shadow-[0px 4px 35px rgba(82, 93, 107, 0.03)] my-8 px-5 py-8 lg:px-8 mx-auto'>
          ...
          <div className='flex flex-col my-8 bg-[#F9FAFB] p-3 lg:p-8 border-[0.6px] border-[#EBE5EB] rounded-[12px] border-solid'>
          ...
          <button className="bg-gradient-to-r from-[#902784] to-[#68299A] rounded-lg text-[#ffffff] w-full h-[60px] font-medium text-[18px] leading-[23px]">Approve</button>
        </div>
      </main>
     )
}
